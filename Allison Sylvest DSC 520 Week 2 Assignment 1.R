...
students <-
  c("Florinda Baird", "Jinny Foss", "Lou Purvis", "Nola Maloney")

rownames(grades) <-
  c("Florinda Baird", "Jinny Foss", "Lou Purvis", "Nola Maloney")
colnames(grades) <-
  c("Assignment 1", "Assignment 2", "Assignment 3")
...
genres_vector <-
  c("Fantasy", "Sci-Fi", "Sci-Fi", "Mystery", "Sci-Fi", "Fantasy")
...
race <-
  c("Men",
    ...
    "Hobbit")
in_fellowship <-
  c(TRUE, FALSE, TRUE, FALSE, TRUE, TRUE, TRUE, FALSE, FALSE)
ring_bearer <-
  c(FALSE, TRUE, TRUE, FALSE, TRUE, TRUE, FALSE, TRUE, TRUE)
age <- c(88, 129, 51, 7000, 36, 2019, 2931, 7052, 589)

characters_df <-
  data.frame(name, race, in_fellowship, ring_bearer, age)
